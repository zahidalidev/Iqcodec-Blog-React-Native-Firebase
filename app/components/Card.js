...
function Card({ key, item }) {
    return (
        <View key={key} style={{ elevation: 2, flexDirection: "row", backgroundColor: Colors.white, width: "90%", height: RFPercentage(14), borderRadius: RFPercentage(1), marginBottom: RFPercentage(1), marginTop: key == 0 ? RFPercentage(2) : RFPercentage(1) }} >
            <View style={{ width: "40%" }} >
